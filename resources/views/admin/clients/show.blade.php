            ...
            <div class="px-6 py-4">
                <dl class="space-y-3">
                    ...
                    <div>
                        ...
                        <dd class="mt-1">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                @if($client->status === 'approved') bg-green-100 text-green-800
                                @elseif($client->status === 'rejected') bg-red-100 text-red-800
                    ...
                    @if($client->status_updated_at)
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ $client->status_updated_at->format('F j, Y g:i A') }}</dd>
                        </div>
                    @endif
                    @if($client->statusUpdatedBy)
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Updated By</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $client->statusUpdatedBy->name }}</dd>
                        </div>
                    @endif
                    @if($client->status_reason)
                        <div>
                            <dt class="text-sm font-medium text-gray-500">Reason</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $client->status_reason }}</dd>
                        </div>
                    @endif
                </dl>
            </div>
            ...
            <div class="bg-white shadow rounded-lg">
                ...
                <div class="px-6 py-4">
                    <div class="text-center">
                        ...
                        <p class="text-sm font-medium text-green-800">Client Approved</p>
                        <button onclick="openApprovalModal('reject')" 
            ...
            <div class="bg-white shadow rounded-lg">
                ...
                <div class="px-6 py-4">
                    <div class="text-center">
                        ...
                        <p class="text-sm font-medium text-red-800">Client Rejected</p>
                        <button onclick="openApprovalModal('approve')" 
        ...
        <div class="mt-3">
            ...
            <form id="approvalForm" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-xs text-gray-500 mt-1">This reason will be included in the email notification to the client.</p>
                </div>
                <div class="flex justify-end space-x-3">
...
<script>
    ...
    function openApprovalModal(action) {
        ...
        if (action === 'approve') {
            ...
            form.action = '{{ route("admin.clients.approve", $client) }}';
            ...
            form.action = '{{ route("admin.clients.reject", $client) }}';
