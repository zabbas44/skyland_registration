    ...
    <div class="max-w-4xl mx-auto relative z-10">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
                Register to request quotations, book site visits, and manage your projects with <span class="text-cyan-400">Sky Land Construction</span>.
            </p>
        </div>
            ...
            <form method="POST" action="{{ route('client.store') }}" enctype="multipart/form-data" class="px-8 py-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="client_type" id="client_type" required
                                    class="w-full px-4 py-3 bg-white/10 backdrop-blur-md border border-white/30 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-white/50 focus:bg-white/15 transition-all duration-300 shadow-lg @error('client_type') border-red-400 @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" name="company_name" id="company_name" required
                                   ...
                                   class="w-full px-4 py-3 bg-white/10 backdrop-blur-md border border-white/30 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-white/50 focus:bg-white/15 transition-all duration-300 shadow-lg @error('company_name') border-red-400 @enderror">
                            @error('company_name')
                                <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="border-t border-gray-200 pt-8">
                    ...
                    <div class="flex justify-center">
                        <button type="submit" 
                                class="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-4 px-8 rounded-lg transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
        ...
        <div class="mt-8 text-center">
            <p class="text-slate-300">
                ...
                <a href="mailto:support@clientsvendors.local" class="text-cyan-400 hover:text-cyan-300 underline">
